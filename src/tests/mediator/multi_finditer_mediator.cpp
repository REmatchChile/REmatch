...
TEST_CASE("the multi mediator returns null pointer when there are no mappings") {
...
TEST_CASE("the multi mediator returns an empty mapping if there are no captures") {
...
TEST_CASE("the multi mediator returns the correct mappings for !x{a} over aaa") {
