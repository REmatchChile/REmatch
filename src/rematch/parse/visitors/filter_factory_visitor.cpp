...
ff_ptr regex2filters::get_factory() { return std::move(filter_factory_); }
...
void regex2filters::operator()(ast::iter const &it) { (*this)(it.expr); }

void regex2filters::operator()(ast::group const &g) {
  boost::apply_visitor(*this, g);
}

void regex2filters::operator()(ast::parenthesis const &p) { (*this)(p.root); }

void regex2filters::operator()(ast::assignation const &a) { (*this)(a.root); }
