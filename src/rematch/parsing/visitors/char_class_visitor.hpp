 ...
 private:
  ...
  std::any visitSpecial(REmatchParser::SpecialContext *ctx) override {
    ...
    // Regular special literals
      ...
      throw REMatch::UnhandledExpressionError("Unhandled Special Literal: " + ctx->getText());
    }
  ...
  std::any visitSharedAtom(REmatchParser::SharedAtomContext *ctx) override {
    ...
    if (ctx->DECIMAL_DIGIT()) {
      ...
      throw REMatch::UnhandledExpressionError("Unhandled Shared Atom: " + ctx->getText());
    }
  ...
  std::any visitCcOther(REmatchParser::CcOtherContext *ctx) override {
    ...
    switch (str.size()) {
      ...
      case 4:
        ...
        break;
      default:
        throw REMatch::InvalidCharacterError("Invalid UTF-8 character: " + str);
    }
