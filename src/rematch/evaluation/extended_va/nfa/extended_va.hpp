...
class ExtendedVA {
 ...
 public:
  ...
  explicit ExtendedVA(LogicalVA const& logical_va);
 ...
 private:
  ...
  void copy_transitions_from_logical_va(LogicalVA& logical_va,
                                        std::map<unsigned int, ExtendedVAState*>& id_map);
  void copy_states_from_logical_va(LogicalVA& logical_va,
                                   std::map<unsigned int, ExtendedVAState*>& id_map);
