...
public:
  ...
  const std::string &operator*() const { return **self_; }

  virtual bool operator!=(EndLineIterator) const { return self_->at_end(); }
...
private:
  ...
  public:
    ...
    virtual void advance() override { ++data_; }

    virtual const std::string &operator*() const override { return *data_; }

    virtual bool at_end() const override { return data_.at_end(); };
...
public:
  ...
  const char &operator*() const { return **self_; }

  virtual bool operator!=(EndCharIterator) const { return self_->at_end(); }
...
private:
  ...
  public:
    ...
    virtual const char &operator*() const override { return *data_; }
